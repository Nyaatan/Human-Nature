...
public class Human extends Organism {
    ...
    public void move() {
        ...
        this.setCoords(API.worldSPI.getCoordsInDirection(this.worldID, this.movementDirection, this.coordinates));
        if(API.worldSPI.getField(this.worldID, this.coordinates)!=null) this.interact(API.worldSPI.getField(this.worldID, this.coordinates));
    } //todo
